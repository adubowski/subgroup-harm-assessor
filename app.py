...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--dataset", type=str, default="credit_g", help="Dataset to be used in the evaluation")
    ...
    parser.add_argument("-s", "--train_split", type=bool, default=True, help="Flag whether to split the number of samples selected into train and test. Only test data is then used for visualizations")
    args = parser.parse_args()
    bias = args.bias if args.bias in ("random", "mean", "swap") else False
    run_app(args.n_samples, args.dataset, bias, args.random_subgroup, args.train_split)
